model Westland_QTH
  ...
  WarmingUp.HeatNetwork.QTH.Pipe pipeS1_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeS2_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeS1and2_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDH_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDG_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDF_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDI_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDE_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDB_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDA_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDC_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDD_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeS5_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeS3_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeS4_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeS6_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe4_cold(disconnectable=false, has_control_valve=true, length=2000., diameter=0.25, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=-Q_max, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), sign_dT=-1.0);
  ...
  WarmingUp.HeatNetwork.QTH.Pipe pipeR2_hot(disconnectable=false, has_control_valve=true, length=4000., diameter=0.3, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=-Q_max, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);

  WarmingUp.HeatNetwork.QTH.Pipe pipeS1_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeS2_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeS1and2_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDH_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDG_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDF_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDE_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDB_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDA_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDC_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDI_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeDD_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeS5_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeS3_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeS4_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipeS6_hot(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground=10.0, Q(min=Q_min, max=Q_max, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), sign_dT=1.0);
