model Westland_Heat
  ...
  WarmingUp.HeatNetwork.Heat.Pipe pipeS1_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=0.0, max=0.0, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=0.0, max=0.0, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
