model Westland_Heat
  ...
  WarmingUp.HeatNetwork.Heat.Source Source1(Heat_source(min=0.0, max=12.5e6, nominal=1e7), Heat_in(nominal=heat_nominal_cold_pipes), Heat_out(nominal=heat_nominal_hot_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Source Source2(Heat_source(min=0.0, max=17.5e6, nominal=1e7), Heat_in(nominal=heat_nominal_cold_pipes), Heat_out(nominal=heat_nominal_hot_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Source Source3(Heat_source(min=0.0, max=15e6, nominal=1e7), Heat_in(nominal=heat_nominal_cold_pipes), Heat_out(nominal=heat_nominal_hot_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Source Source12(Heat_source(min=0.0, max=40e6, nominal=1e7), Heat_in(nominal=heat_nominal_cold_pipes), Heat_out(nominal=heat_nominal_hot_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Source Source4(Heat_source(min=0.0, max=17.5e6, nominal=1e7), Heat_in(nominal=heat_nominal_cold_pipes), Heat_out(nominal=heat_nominal_hot_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Source Source6(Heat_source(min=0.0, max=40e6, nominal=1e7), Heat_in(nominal=heat_nominal_cold_pipes), Heat_out(nominal=heat_nominal_hot_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Source Source5(Heat_source(min=0.0, max=12.5e6, nominal=1e7), Heat_in(nominal=heat_nominal_cold_pipes), Heat_out(nominal=heat_nominal_hot_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);

  WarmingUp.HeatNetwork.Heat.Pipe pipeS1_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeS2_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeS1and2_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeDH_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeDG_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeDF_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeDI_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeDE_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeDB_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeDA_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeDC_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeDD_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeS5_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeS3_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeS4_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeS6_cold(disconnectable=false, has_control_valve=false, length=5., diameter=0.2, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipe4_cold(disconnectable=false, has_control_valve=true, length=2000., diameter=0.25, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipe3_cold(disconnectable=false, has_control_valve=false, length=2500., diameter=0.3, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipe5_cold(disconnectable=false, has_control_valve=false, length=2900., diameter=0.5, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipe2_cold(disconnectable=false, has_control_valve=false, length=3900., diameter=0.4, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipe1_cold(disconnectable=false, has_control_valve=false, length=2700., diameter=0.25, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);

  WarmingUp.HeatNetwork.Heat.Pipe pipepump1_cold(disconnectable=false, has_control_valve=false, length=1., diameter=0.25, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipepump2_cold(disconnectable=false, has_control_valve=false, length=1., diameter=0.25, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipepump3_cold(disconnectable=false, has_control_valve=false, length=1., diameter=0.25, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipepump4_cold(disconnectable=false, has_control_valve=false, length=1., diameter=0.25, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipepump5_cold(disconnectable=false, has_control_valve=false, length=1., diameter=0.25, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipepump6_cold(disconnectable=false, has_control_valve=false, length=1., diameter=0.25, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipepump12_cold(disconnectable=false, has_control_valve=false, length=1., diameter=0.25, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);

  WarmingUp.HeatNetwork.Heat.Pipe pipe6a_hot(disconnectable=false, has_control_valve=true, length=2700., diameter=0.25, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=0.0, max=heat_max_abs, nominal=heat_nominal_hot_pipes), HeatIn.Heat(min=0.0, max=heat_max_abs, nominal=heat_nominal_hot_pipes), Q_nominal=Q_nominal);
  ...
  WarmingUp.HeatNetwork.Heat.Pipe pipeR2_hot(disconnectable=false, has_control_valve=true, length=4000., diameter=0.3, temperature=85.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_hot_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_hot_pipes), Q_nominal=Q_nominal);
  ...
  WarmingUp.HeatNetwork.Heat.Pipe pipe6a_cold(disconnectable=false, has_control_valve=true, length=2700., diameter=0.25, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipe6b_cold(disconnectable=false, has_control_valve=false, length=2700., diameter=0.25, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipe7a_cold(disconnectable=false, has_control_valve=true, length=2600., diameter=0.5, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipe7b_cold(disconnectable=false, has_control_valve=false, length=2600., diameter=0.5, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipe8a_cold(disconnectable=false, has_control_valve=false, length=3300., diameter=0.4, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeR1_cold(disconnectable=false, has_control_valve=true, length=5200., diameter=0.3, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipe9a_cold(disconnectable=false, has_control_valve=false, length=3300., diameter=0.4, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipe9b_cold(disconnectable=false, has_control_valve=false, length=1600., diameter=0.4, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pipe pipeR2_cold(disconnectable=false, has_control_valve=true, length=4000., diameter=0.3, temperature=35.0, T_supply=85.0, T_return=35.0, T_ground = 10.0, HeatOut.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), HeatIn.Heat(min=-heat_max_abs, max=heat_max_abs, nominal=heat_nominal_cold_pipes), Q_nominal=Q_nominal);

  WarmingUp.HeatNetwork.Heat.Demand DemandH(Heat_demand(min=0.0, max=heat_max_abs, nominal=heat_max_abs), Heat_in(nominal=heat_nominal_hot_pipes), Heat_out(nominal=heat_nominal_cold_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Demand DemandG(Heat_demand(min=0.0, max=heat_max_abs, nominal=heat_max_abs), Heat_in(nominal=heat_nominal_hot_pipes), Heat_out(nominal=heat_nominal_cold_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Demand DemandF(Heat_demand(min=0.0, max=heat_max_abs, nominal=heat_max_abs), Heat_in(nominal=heat_nominal_hot_pipes), Heat_out(nominal=heat_nominal_cold_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Demand DemandI(Heat_demand(min=0.0, max=heat_max_abs, nominal=heat_max_abs), Heat_in(nominal=heat_nominal_hot_pipes), Heat_out(nominal=heat_nominal_cold_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Demand DemandJ(Heat_demand(min=0.0, max=heat_max_abs, nominal=heat_max_abs), Heat_in(nominal=heat_nominal_hot_pipes), Heat_out(nominal=heat_nominal_cold_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Demand DemandE(Heat_demand(min=0.0, max=heat_max_abs, nominal=heat_max_abs), Heat_in(nominal=heat_nominal_hot_pipes), Heat_out(nominal=heat_nominal_cold_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Demand DemandB(Heat_demand(min=0.0, max=heat_max_abs, nominal=heat_max_abs), Heat_in(nominal=heat_nominal_hot_pipes), Heat_out(nominal=heat_nominal_cold_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Demand DemandC(Heat_demand(min=0.0, max=heat_max_abs, nominal=heat_max_abs), Heat_in(nominal=heat_nominal_hot_pipes), Heat_out(nominal=heat_nominal_cold_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Demand DemandA(Heat_demand(min=0.0, max=heat_max_abs, nominal=heat_max_abs), Heat_in(nominal=heat_nominal_hot_pipes), Heat_out(nominal=heat_nominal_cold_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Demand DemandD(Heat_demand(min=0.0, max=heat_max_abs, nominal=heat_max_abs), Heat_in(nominal=heat_nominal_hot_pipes), Heat_out(nominal=heat_nominal_cold_pipes), T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  ...
  WarmingUp.HeatNetwork.Heat.Pump pump1(T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pump pump2(T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pump pump3(T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pump pump4(T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pump pump5(T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pump pump6(T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
  WarmingUp.HeatNetwork.Heat.Pump pump12(T_supply=85.0, T_return=35.0, Q_nominal=Q_nominal);
