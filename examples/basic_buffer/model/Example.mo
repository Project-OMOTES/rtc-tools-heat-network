model Example
  ...
  WarmingUp.HeatNetwork.QTH.Pipe pipe4a_cold(length = 5, diameter = 0.15, temperature=45.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), theta = theta, sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe4b_cold(length = 15, diameter = 0.15, temperature=45.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), theta = theta, sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe5_cold(length = 126, diameter = 0.15, temperature=45.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), theta = theta, sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe7_cold(length = 60, diameter = 0.15, temperature=45.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), theta = theta, sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe9_cold(length = 70, diameter = 0.15, temperature=45.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), theta = theta, sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe15_cold(length = 129, diameter = 0.15, temperature=45.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), theta = theta, sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe25_cold(length = 150, diameter = 0.15, temperature=45.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), theta = theta, sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe26_cold(length = 30, diameter = 0.1, temperature=45.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), theta = theta, sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe27_cold(length = 55, diameter = 0.15, temperature=45.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), theta = theta, sign_dT=-1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe29_cold(length = 134, diameter = 0.15, temperature=45.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_return_min, max=t_return_max), QTHOut.T(min=t_return_min, max=t_return_max), theta = theta, sign_dT=-1.0);
  ...
  WarmingUp.HeatNetwork.QTH.Pipe pipe4a_hot(length = 5, diameter = 0.15, temperature=75.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), theta = theta, sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe4b_hot(length = 15, diameter = 0.15, temperature=75.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), theta = theta, sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe5_hot(length = 126, diameter = 0.15, temperature=75.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), theta = theta, sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe7_hot(length = 60, diameter = 0.15, temperature=75.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), theta = theta, sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe9_hot(length = 70, diameter = 0.15, temperature=75.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), theta = theta, sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe15_hot(length = 129, diameter = 0.15, temperature=75.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), theta = theta, sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe25_hot(length = 150, diameter = 0.15, temperature=75.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), theta = theta, sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe26_hot(length = 30, diameter = 0.1, temperature=75.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), theta = theta, sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe27_hot(length = 55, diameter = 0.15, temperature=75.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), theta = theta, sign_dT=1.0);
  WarmingUp.HeatNetwork.QTH.Pipe pipe29_hot(length = 134, diameter = 0.15, temperature=75.0, Q(min=0.0, nominal=Q_nominal), QTHIn.T(min=t_supply_min, max=t_supply_max), QTHOut.T(min=t_supply_min, max=t_supply_max), theta = theta, sign_dT=1.0);
