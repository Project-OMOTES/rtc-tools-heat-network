model Example_Heat
  ...
  WarmingUp.HeatNetwork.Heat.Pipe pipe1a_cold(length = 170.365, diameter = 0.15, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe1b_cold(length = 309.635, diameter = 0.15, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe4a_cold(length = 5, diameter = 0.15, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe4b_cold(length = 15, diameter = 0.15, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe5_cold(length = 126, diameter = 0.15, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe7_cold(length = 60, diameter = 0.15, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe9_cold(length = 70, diameter = 0.15, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe15_cold(length = 129, diameter = 0.15, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe25_cold(length = 150, diameter = 0.15, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe26_cold(length = 30, diameter = 0.1, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe27_cold(length = 55, diameter = 0.15, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe29_cold(length = 134, diameter = 0.15, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe30_cold(length = 60, diameter = 0.1, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe31_cold(length = 60, diameter = 0.1, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe32_cold(length = 50, diameter = 0.1, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
  WarmingUp.HeatNetwork.Heat.Pipe pipe52_cold(disconnectable = true, length = 10, diameter = 0.164, temperature=45.0, T_supply=75.0, T_return=45.0, HeatOut.Heat(nominal=heat_nominal_cold_pipes), HeatIn.Heat(max=heat_max_abs, nominal=heat_nominal_cold_pipes));
