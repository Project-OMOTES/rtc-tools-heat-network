...
class PipeDiameterSizingProblem(
    ...
    def pipe_classes(self, pipe):
        return [
            PipeClass("None", 0.0, 0.0, (0.0, 0.0)),
            PipeClass("DN40", 0.0431, 1.5, (0.179091, 0.005049)),
            PipeClass("DN50", 0.0545, 1.7, (0.201377, 0.006086)),
            PipeClass("DN65", 0.0703, 1.9, (0.227114, 0.007300)),
            PipeClass("DN80", 0.0825, 2.2, (0.238244, 0.007611)),
            PipeClass("DN100", 0.1071, 2.4, (0.247804, 0.007386)),
            PipeClass("DN125", 0.1325, 2.6, (0.287779, 0.009431)),
            PipeClass("DN150", 0.1603, 2.8, (0.328592, 0.011567)),
            PipeClass("DN200", 0.2101, 3.0, (0.346285, 0.011215)),
            PipeClass("DN250", 0.263, 3.0, (0.334606, 0.009037)),
            PipeClass("DN300", 0.3127, 3.0, (0.384640, 0.011141)),
            PipeClass("DN350", 0.3444, 3.0, (0.368061, 0.009447)),
            PipeClass("DN400", 0.3938, 3.0, (0.381603, 0.009349)),
            PipeClass("DN450", 0.4444, 3.0, (0.380070, 0.008506)),
            PipeClass("DN500", 0.4954, 3.0, (0.369282, 0.007349)),
            PipeClass("DN600", 0.5954, 3.0, (0.431023, 0.009155)),
        ]
