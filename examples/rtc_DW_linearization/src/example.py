...
class Example(GoalProgrammingMixin, CSVMixin, ModelicaMixin,
    ...
    def path_constraints(self, ensemble_member):
        ...
        # Extract the parameters set in the Modelica model
        ...
        for pipe in self.pipes:
            ...
            wall_roughness = 2E-3
            if 'in' in pipe or 'out' in pipe:
                # For the pipes in and out of the buffer allow max velocity of 1.0
                n_lines=10
                v_max = 1.0
            else:
    ...
    def post(self):
        ...
        # #Plot2 Upper subplot: Q vs dH for linarization and DW
        # axarr[0].set_title("Darcy Weisbach vs linearization")
        ...
        # # axarr[1].set_title("Darcy Weisbach vs opt results")
        # # axarr[1].set_xlabel("Discharge Q [m3/s]")
        # axarr[1].set_ylabel("dH [m]")
        # q_opt = results[pipe+'.Q']
        # dH_opt = -results[pipe+'.dH']
        # axarr[1].plot(q_points, dH_dw, linewidth=2, color="b", label="D-W")
