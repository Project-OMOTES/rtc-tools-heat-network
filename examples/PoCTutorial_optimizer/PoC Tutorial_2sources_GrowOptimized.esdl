...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="PoC Tutorial_2sources_GrowOptimized" description="" esdlVersion="v2207" version="17" id="b4dddf9b-d609-4784-8d66-f55cfd6790e0">
  <instance xsi:type="esdl:Instance" name="Untitled instance" id="9af52a01-24e2-4bbe-a7b8-f868161e6ca3">
    <area xsi:type="esdl:Area" id="9edf5aa3-3855-4dac-b6f5-01c2edf1a43a" name="Untitled area">
      <area xsi:type="esdl:Area" id="76a75122-8ea6-472d-8059-374830275d72" name="Area_76a7">
        ...
        <KPIs xsi:type="esdl:KPIs" id="3867b16a-d397-4574-b36b-473b5f682627">
      ...
      <area xsi:type="esdl:Area" id="9d0fd9ed-662c-42ec-a417-7e789737084c" name="Area_9d0f">
        ...
        <KPIs xsi:type="esdl:KPIs" id="810e2062-5833-4b82-98c9-77c6c93742a5">
          <kpi xsi:type="esdl:DoubleKPI" name="Investment" value="1.5">
            <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" multiplier="MEGA" unit="EURO" physicalQuantity="COST"/>
          </kpi>
          <kpi xsi:type="esdl:DoubleKPI" name="Installation" value="0.1">
      ...
      <area xsi:type="esdl:Area" id="a58a988c-95c1-492b-bc63-b125d25f5108" name="Area_a58a">
        ...
        <KPIs xsi:type="esdl:KPIs" id="264fcd57-8672-409d-bdb0-b83d037cbede">
          <kpi xsi:type="esdl:DoubleKPI" name="Investment" value="1.5">
            <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" multiplier="MEGA" unit="EURO" physicalQuantity="COST"/>
          </kpi>
          <kpi xsi:type="esdl:DoubleKPI" name="Installation" value="0.1">
      ...
      <KPIs xsi:type="esdl:KPIs" id="69767970-f550-4a71-bbb0-b775167e52ef">
        <kpi xsi:type="esdl:DistributionKPI" name="High level cost breakdown [EUR]">
          ...
          <distribution xsi:type="esdl:StringLabelDistribution">
            <stringItem xsi:type="esdl:StringItem" value="34465043.65392579" label="CAPEX"/>
            <stringItem xsi:type="esdl:StringItem" value="5737157.948888398" label="OPEX"/>
          </distribution>
        </kpi>
        <kpi xsi:type="esdl:DistributionKPI" name="Overall cost breakdown [EUR]">
          ...
          <distribution xsi:type="esdl:StringLabelDistribution">
            ...
            <stringItem xsi:type="esdl:StringItem" value="32165043.653925788" label="Investment"/>
            <stringItem xsi:type="esdl:StringItem" value="2892682.0845862096" label="Variable OPEX"/>
            <stringItem xsi:type="esdl:StringItem" value="2844475.864302188" label="Fixed OPEX"/>
          </distribution>
        </kpi>
        <kpi xsi:type="esdl:DistributionKPI" name="CAPEX breakdown [EUR]">
          <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" unit="EURO" physicalQuantity="COST"/>
          <distribution xsi:type="esdl:StringLabelDistribution">
            <stringItem xsi:type="esdl:StringItem" value="13851982.767925784" label="ResidualHeatSource"/>
            <stringItem xsi:type="esdl:StringItem" value="15813060.886" label="Pipe"/>
        ...
        <kpi xsi:type="esdl:DistributionKPI" name="OPEX breakdown [EUR]">
          <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" unit="EURO" physicalQuantity="COST"/>
          <distribution xsi:type="esdl:StringLabelDistribution">
            <stringItem xsi:type="esdl:StringItem" value="7086776.168880284" label="ResidualHeatSource"/>
          </distribution>
        </kpi>
        <kpi xsi:type="esdl:DistributionKPI" name="Energy production [Wh]">
          <distribution xsi:type="esdl:StringLabelDistribution">
            <stringItem xsi:type="esdl:StringItem" value="3205576033.7782955" label="ResidualHeatSource_72d7"/>
            <stringItem xsi:type="esdl:StringItem" value="138222952161.75385" label="ResidualHeatSource_76f0"/>
          </distribution>
        </kpi>
      ...
      <asset xsi:type="esdl:ResidualHeatSource" power="10178293.155339617" id="72d74fb5-134f-4bfb-829e-220ab76a8a7b" name="ResidualHeatSource_72d7">
