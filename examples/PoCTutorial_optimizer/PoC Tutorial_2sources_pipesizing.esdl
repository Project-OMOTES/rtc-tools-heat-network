...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" version="18" id="15174819-d1af-4ba6-9f1d-2cd07991f14a" description="" esdlVersion="v2207" name="PoC Tutorial_2sources">
  <instance xsi:type="esdl:Instance" id="9af52a01-24e2-4bbe-a7b8-f868161e6ca3" name="Untitled instance">
    <area xsi:type="esdl:Area" id="9edf5aa3-3855-4dac-b6f5-01c2edf1a43a" name="Untitled area">
      ...
      <asset xsi:type="esdl:ResidualHeatSource" state="OPTIONAL" id="72d74fb5-134f-4bfb-829e-220ab76a8a7b" power="50000000.0" name="ResidualHeatSource_72d7">
      ...
      <asset xsi:type="esdl:Pipe" innerDiameter="0.3938" related="Pipe1_ret" id="Pipe1" state="OPTIONAL" outerDiameter="0.56" diameter="DN400" name="Pipe1" length="818.07">
      ...
      <asset xsi:type="esdl:Pipe" innerDiameter="0.3938" related="Pipe2_ret" id="Pipe2" state="OPTIONAL" outerDiameter="0.56" diameter="DN400" name="Pipe2" length="517.54">
      ...
      <asset xsi:type="esdl:Pipe" innerDiameter="0.3938" related="Pipe3_ret" id="Pipe3" state="OPTIONAL" outerDiameter="0.56" diameter="DN400" name="Pipe3" length="1182.23">
      ...
      <asset xsi:type="esdl:Pipe" innerDiameter="0.3127" related="Pipe4_ret" id="Pipe4" state="OPTIONAL" outerDiameter="0.45" diameter="DN300" name="Pipe4" length="455.4">
      ...
      <asset xsi:type="esdl:Pipe" innerDiameter="0.3127" related="Pipe5_ret" id="Pipe5" state="OPTIONAL" outerDiameter="0.45" diameter="DN300" name="Pipe5" length="252.3">
      ...
      <asset xsi:type="esdl:Joint" id="b4a5be45-3352-4837-94d6-b110aa842da6" name="Joint_95ca_ret">
        ...
        <port xsi:type="esdl:OutPort" connectedTo="da70a1aa-53c4-496e-ba63-2c04674b8c84 c92afccb-09a2-4a99-ad98-3f18ca0122dd" carrier="9f6aeb1a-138b-4bb9-9a09-d524e94658e6_ret" name="ret_port" id="5a47482f-6cdf-41b3-91b0-014578ee8143"/>
        <geometry xsi:type="esdl:Point" CRS="WGS84" lat="51.99571274701101" lon="4.369031429215318"/>
      </asset>
      <asset xsi:type="esdl:Pipe" innerDiameter="0.3938" related="Pipe1" id="Pipe1_ret" state="OPTIONAL" outerDiameter="0.56" diameter="DN400" name="Pipe1_ret" length="818.07">
      ...
      <asset xsi:type="esdl:Pipe" innerDiameter="0.3938" related="Pipe2" id="Pipe2_ret" state="OPTIONAL" outerDiameter="0.56" diameter="DN400" name="Pipe2_ret" length="517.54">
      ...
      <asset xsi:type="esdl:Pipe" innerDiameter="0.3938" related="Pipe3" id="Pipe3_ret" state="OPTIONAL" outerDiameter="0.56" diameter="DN400" name="Pipe3_ret" length="1182.23">
      ...
      <asset xsi:type="esdl:Pipe" innerDiameter="0.3127" related="Pipe4" id="Pipe4_ret" state="OPTIONAL" outerDiameter="0.45" diameter="DN300" name="Pipe4_ret" length="455.4">
      ...
      <asset xsi:type="esdl:Pipe" innerDiameter="0.3127" related="Pipe5" id="Pipe5_ret" state="OPTIONAL" outerDiameter="0.45" diameter="DN300" name="Pipe5_ret" length="252.3">
      ...
      <asset xsi:type="esdl:ResidualHeatSource" state="OPTIONAL" id="76f0817c-9f01-431e-be96-dbf3ee806d76" power="50000000.0" name="ResidualHeatSource_76f0">
      ...
      <asset xsi:type="esdl:Pipe" innerDiameter="0.263" id="8fa58f83-6d2c-4ed7-b8bb-d83d089a3932" state="OPTIONAL" outerDiameter="0.4" diameter="DN250" name="Pipe_8fa5" length="356.2">
      ...
      <asset xsi:type="esdl:Pipe" innerDiameter="0.263" id="c4b13a2c-8331-4deb-9580-af593a1854d4" state="OPTIONAL" outerDiameter="0.4" diameter="DN250" name="Pipe_8fa5_ret" length="304.4">
        ...
        <port xsi:type="esdl:OutPort" connectedTo="4d708ad1-b369-47a3-abd3-26aa96173e71" carrier="9f6aeb1a-138b-4bb9-9a09-d524e94658e6_ret" name="Out" id="3d19f298-ae58-4e56-92b6-e3ea896af6cb"/>
        <geometry xsi:type="esdl:Line" CRS="WGS84">
