...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="PoC Tutorial_1source" description="" version="17" esdlVersion="v2207" id="15174819-d1af-4ba6-9f1d-2cd07991f14a">
  <instance xsi:type="esdl:Instance" name="Untitled instance" id="9af52a01-24e2-4bbe-a7b8-f868161e6ca3">
    <area xsi:type="esdl:Area" name="Untitled area" id="9edf5aa3-3855-4dac-b6f5-01c2edf1a43a">
      ...
      <asset xsi:type="esdl:Pipe" length="818.07" innerDiameter="0.3938" outerDiameter="0.56" id="Pipe1" name="Pipe1" related="Pipe1_ret" diameter="DN400">
      ...
      <asset xsi:type="esdl:Joint" id="95caf7c7-e89f-4378-96f2-f904f9255c83" name="Joint_95ca">
        ...
        <port xsi:type="esdl:InPort" connectedTo="8c38fc93-ed85-42ef-9be6-87d47c416e90" name="In" id="4d629e6e-5db4-4a8f-9945-934a24ede11a" carrier="9f6aeb1a-138b-4bb9-9a09-d524e94658e6"/>
      ...
      <asset xsi:type="esdl:Joint" id="b4a5be45-3352-4837-94d6-b110aa842da6" name="Joint_95ca_ret">
        ...
        <port xsi:type="esdl:OutPort" connectedTo="da70a1aa-53c4-496e-ba63-2c04674b8c84" name="ret_port" id="5a47482f-6cdf-41b3-91b0-014578ee8143" carrier="9f6aeb1a-138b-4bb9-9a09-d524e94658e6_ret"/>
      </asset>
      <asset xsi:type="esdl:Pipe" length="818.07" innerDiameter="0.3938" outerDiameter="0.56" id="Pipe1_ret" name="Pipe1_ret" related="Pipe1" diameter="DN400">
        <geometry xsi:type="esdl:Line">
