...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="PoC Tutorial_2sources_storage with return network" description="" version="20" esdlVersion="v2207" id="15174819-d1af-4ba6-9f1d-2cd07991f14a_with_return_network">
  <instance xsi:type="esdl:Instance" id="9af52a01-24e2-4bbe-a7b8-f868161e6ca3" name="Untitled instance">
    <area xsi:type="esdl:Area" name="Untitled area" id="9edf5aa3-3855-4dac-b6f5-01c2edf1a43a">
      <area xsi:type="esdl:Area" id="76a75122-8ea6-472d-8059-374830275d72" name="Area_76a7">
        ...
        <asset xsi:type="esdl:HeatingDemand" power="15000000.0" id="b0ff0df6-4a47-43a5-a0a5-aa10975c0a5c" name="HeatingDemand_b0ff">
          ...
          <port xsi:type="esdl:InPort" connectedTo="5169316d-ae93-4f04-9a34-7c776444b651" name="In" id="2c5a109b-0d98-47b6-acc1-05e1708f8b85" carrier="9f6aeb1a-138b-4bb9-9a09-d524e94658e6">
            <profile xsi:type="esdl:InfluxDBProfile" measurement="WarmingUp default profiles" filters="" startDate="2018-12-31T23:00:00.000000+0000" database="energy_profiles" field="demand4_MW" host="profiles.warmingup.info" port="443" endDate="2019-12-31T22:00:00.000000+0000" id="b8150ac7-ea23-4be6-b5a3-b6974b8df58d" multiplier="5.0">
          ...
          <costInformation xsi:type="esdl:CostInformation" id="cd676c1c-6224-406f-a864-3e7ff55265e0">
            <investmentCosts xsi:type="esdl:SingleValue" value="100000.0" id="08f06cd1-471b-404a-8894-27b315775b59">
              <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perUnit="WATT" perMultiplier="MEGA" description="Cost in EUR/MW" physicalQuantity="COST" unit="EURO" id="f8e5bc00-6eae-47d6-b7ad-b9699879b14c"/>
            </investmentCosts>
            <installationCosts xsi:type="esdl:SingleValue" value="100000.0" id="829c1c62-4266-4560-ac77-b961b7a722cf">
              <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" id="1c0a9d42-bb5a-44c1-9ed6-824d7c82e932" description="Cost in EUR" unit="EURO"/>
            </installationCosts>
          </costInformation>
        </asset>
      </area>
      <area xsi:type="esdl:Area" id="9d0fd9ed-662c-42ec-a417-7e789737084c" name="Area_9d0f">
        ...
        <asset xsi:type="esdl:HeatingDemand" power="15000000.0" id="08fd3385-681a-4211-a083-51775cc99daa" name="HeatingDemand_08fd">
          ...
          <port xsi:type="esdl:InPort" connectedTo="787c6ae3-96da-41e1-af86-6e68a1e28cb1" name="In" id="01caa60f-1549-4f3f-817e-e4e6807b2398" carrier="9f6aeb1a-138b-4bb9-9a09-d524e94658e6">
            <profile xsi:type="esdl:InfluxDBProfile" measurement="WarmingUp default profiles" filters="" startDate="2018-12-31T23:00:00.000000+0000" database="energy_profiles" field="demand4_MW" host="profiles.warmingup.info" port="443" endDate="2019-12-31T22:00:00.000000+0000" id="ddd73fb0-d96f-4127-8d39-869455c77930" multiplier="10.0">
              <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitReference" reference="e9405fc8-5e57-4df5-8584-4babee7cdf1b"/>
            </profile>
          </port>
          ...
          <costInformation xsi:type="esdl:CostInformation" id="7eac6b5e-ba11-4ef1-b90e-599dd2690d20">
            <investmentCosts xsi:type="esdl:SingleValue" value="100000.0" id="26aba0b6-a1a0-4610-97b3-be763548c669">
              <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perUnit="WATT" perMultiplier="MEGA" description="Cost in EUR/MW" physicalQuantity="COST" unit="EURO" id="424508c6-24aa-4a35-81e9-7ae198cbaeb8"/>
            </investmentCosts>
            <installationCosts xsi:type="esdl:SingleValue" value="100000.0" id="3b93383a-2ec4-4b35-9335-ebd91f0de600">
              <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" id="318840e0-6f48-46f4-b9c9-91315d7b45fd" description="Cost in EUR" unit="EURO"/>
            </installationCosts>
          </costInformation>
        </asset>
      </area>
      <area xsi:type="esdl:Area" id="a58a988c-95c1-492b-bc63-b125d25f5108" name="Area_a58a">
        ...
        <asset xsi:type="esdl:HeatingDemand" power="15000000.0" id="8fbe3d4e-5d5b-4489-9271-9969c2b9e589" name="HeatingDemand_8fbe">
          ...
          <port xsi:type="esdl:InPort" connectedTo="13edd58c-4a04-4770-8aac-c6e8689acbba" name="In" id="23cdb929-5cfc-4b8d-963e-06b6e6cf3a5c" carrier="9f6aeb1a-138b-4bb9-9a09-d524e94658e6">
            <profile xsi:type="esdl:InfluxDBProfile" measurement="WarmingUp default profiles" filters="" startDate="2018-12-31T23:00:00.000000+0000" database="energy_profiles" field="demand3_MW" host="profiles.warmingup.info" port="443" endDate="2019-12-31T22:00:00.000000+0000" id="5ae97047-619a-4119-84f3-848b36743e5d" multiplier="5.0">
              <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitReference" reference="e9405fc8-5e57-4df5-8584-4babee7cdf1b"/>
            </profile>
          </port>
          ...
          <costInformation xsi:type="esdl:CostInformation" id="32e59a3e-fe5e-4201-bbd6-4f26dc4c961e">
            <investmentCosts xsi:type="esdl:SingleValue" value="100000.0" id="3971c64d-50e4-47ec-a769-1f91935065d9">
              <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perUnit="WATT" perMultiplier="MEGA" description="Cost in EUR/MW" physicalQuantity="COST" unit="EURO" id="5a0e43e1-b141-4626-87eb-487cdb70e60e"/>
            </investmentCosts>
            <installationCosts xsi:type="esdl:SingleValue" value="100000.0" id="850701a9-ec9a-40c5-ab3e-e0dbe6165cb6">
              <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" id="b18cdc99-6303-404c-958a-1a4c079f842d" description="Cost in EUR" unit="EURO"/>
            </installationCosts>
          </costInformation>
        </asset>
      </area>
      <asset xsi:type="esdl:ResidualHeatSource" power="50000000.0" id="72d74fb5-134f-4bfb-829e-220ab76a8a7b" state="OPTIONAL" name="ResidualHeatSource_72d7">
        ...
        <port xsi:type="esdl:InPort" connectedTo="e78131b7-4501-4115-940e-ccc76617bccb" name="In" id="4d6c18cd-cc52-443d-8e53-96cd188dd1a8" carrier="9f6aeb1a-138b-4bb9-9a09-d524e94658e6_ret"/>
        <costInformation xsi:type="esdl:CostInformation" id="123cc46e-f8ef-42f9-842f-08e77dd06899">
          <variableOperationalCosts xsi:type="esdl:SingleValue" value="40.0" id="e5bc1b5e-23b1-4985-94f2-bea25c12da14">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perUnit="WATTHOUR" perMultiplier="MEGA" description="Cost in EUR/MWh" physicalQuantity="COST" unit="EURO" id="de56cc5d-2baa-451c-b38c-47abea1393c2"/>
          </variableOperationalCosts>
          <installationCosts xsi:type="esdl:SingleValue" value="1000000.0" id="12c24715-08dc-4b61-ae15-76541704c83a">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" id="89b04c83-eb32-49a3-adc4-492a719221d3" description="Cost in EUR" unit="EURO"/>
          </installationCosts>
          <marginalCosts xsi:type="esdl:SingleValue" value="2.0" id="e52de449-7340-4878-b582-d20711d9fb14">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" id="4fccbb6b-2e41-46d9-a92c-f94da7c3aca7" description="Cost in EUR" unit="EURO"/>
          </marginalCosts>
          <investmentCosts xsi:type="esdl:SingleValue" value="500000.0" id="3102215e-50a4-4332-b16e-2fd6522df31b">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perUnit="WATT" perMultiplier="MEGA" description="Cost in EUR/MW" physicalQuantity="COST" unit="EURO" id="69673880-fe81-4f34-8fd9-558cc693a251"/>
          </investmentCosts>
          <fixedOperationalCosts xsi:type="esdl:SingleValue" value="120000.0" id="8ee43904-745d-4f5c-8b15-5a2adcde7e5f">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perUnit="WATT" perMultiplier="MEGA" description="Cost in EUR/MW" physicalQuantity="COST" unit="EURO" id="4c3a445d-d13f-4f61-8d75-22280135830f"/>
          </fixedOperationalCosts>
        </costInformation>
      </asset>
      <asset xsi:type="esdl:Pipe" length="818.07" outerDiameter="0.56" innerDiameter="0.3938" id="Pipe1_1" name="Pipe1_1" state="OPTIONAL" related="Pipe1_1_ret" diameter="DN400">
      ...
      <asset xsi:type="esdl:Pipe" length="1182.23" outerDiameter="0.56" innerDiameter="0.3938" id="Pipe3_1" name="Pipe3_1" related="Pipe3_1_ret" diameter="DN400">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="455.4" outerDiameter="0.45" innerDiameter="0.3127" id="Pipe4_1" name="Pipe4_1" related="Pipe4_1_ret" diameter="DN300">
      ...
      <asset xsi:type="esdl:Pipe" length="252.3" outerDiameter="0.45" innerDiameter="0.3127" id="Pipe5_1" name="Pipe5_1" related="Pipe5_1_ret" diameter="DN300">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lat="51.995622746921015" lon="4.36983346939087"/>
      ...
      <asset xsi:type="esdl:ResidualHeatSource" power="50000000.0" id="76f0817c-9f01-431e-be96-dbf3ee806d76" state="OPTIONAL" name="ResidualHeatSource_76f0">
        ...
        <costInformation xsi:type="esdl:CostInformation" id="8a3abfe2-d012-489d-87c3-2732a6d4b25f">
          <variableOperationalCosts xsi:type="esdl:SingleValue" value="20.0" id="233a17e9-7392-49fb-a833-f8761c322098">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perUnit="WATTHOUR" perMultiplier="MEGA" description="Cost in EUR/MWh" physicalQuantity="COST" unit="EURO" id="6fad95f6-2d6b-4310-9f76-9b3a26b3bd40"/>
          </variableOperationalCosts>
          <installationCosts xsi:type="esdl:SingleValue" value="1000000.0" id="938b0cb2-d1e5-4fcc-bf45-6de3b5b06de2">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" id="44294593-d3b9-4940-9b58-699ccbb28b86" description="Cost in EUR" unit="EURO"/>
          </installationCosts>
          <marginalCosts xsi:type="esdl:SingleValue" value="1.0" id="c36fe934-9dc9-4ef1-bd6b-6e1e4168ae91">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" id="4cfb1695-3026-49fa-a8ba-2f90450196d4" description="Cost in EUR" unit="EURO"/>
          </marginalCosts>
          <investmentCosts xsi:type="esdl:SingleValue" value="250000.0" id="a572009d-83d3-48ba-8727-e41267ca5350">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perUnit="WATT" perMultiplier="MEGA" description="Cost in EUR/MW" physicalQuantity="COST" unit="EURO" id="6862d724-1794-4bab-b666-258fd14150ac"/>
          </investmentCosts>
          <fixedOperationalCosts xsi:type="esdl:SingleValue" value="60000.0" id="b1b80150-e761-4633-b9d5-81b1d69a6db8">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perUnit="WATT" perMultiplier="MEGA" description="Cost in EUR/MW" physicalQuantity="COST" unit="EURO" id="2c63c99b-cc4c-471a-a83e-a0d25cad5b7e"/>
          </fixedOperationalCosts>
        </costInformation>
      </asset>
      <asset xsi:type="esdl:Pipe" length="356.2" outerDiameter="0.4" innerDiameter="0.263" id="Pipe1" name="Pipe1" state="OPTIONAL" related="Pipe1_ret" diameter="DN250">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:ATES" aquiferPorosity="0.3" aquiferMidTemperature="17.0" aquiferTopDepth="300.0" maxChargeRate="11610000.0" wellDistance="150.0" name="ATES_9418" salinity="10000.0" aquiferPermeability="10000.0" aquiferNetToGross="1.0" aquiferThickness="45.0" maxDischargeRate="11610000.0" wellCasingSize="13.0" id="94180b94-ab68-4b63-93a4-7fd53377fc39" aquiferAnisotropy="4.0">
      ...
      <asset xsi:type="esdl:Pipe" length="371.04" outerDiameter="0.56" innerDiameter="0.3938" id="Pipe2" name="Pipe2" related="Pipe2_ret" diameter="DN400">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lat="51.99996926872789" lon="4.367129802703858"/>
      ...
      <asset xsi:type="esdl:Pipe" length="146.5" outerDiameter="0.56" innerDiameter="0.3938" id="Pipe3" name="Pipe3" related="Pipe3_ret" diameter="DN400">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lat="51.9968514417669" lon="4.369060993194581"/>
          <point xsi:type="esdl:Point" lat="51.995622746921015" lon="4.36983346939087"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" length="347.2" outerDiameter="0.56" innerDiameter="0.3938" id="Pipe4" name="Pipe4" state="OPTIONAL" related="Pipe4_ret" diameter="DN400">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lat="51.9968514417669" lon="4.369060993194581"/>
      ...
      <asset xsi:type="esdl:Joint" id="46b7c740-70de-40b1-a208-f656005bc703" name="Joint_a04c_ret">
        ...
        <port xsi:type="esdl:OutPort" connectedTo="31b83f9c-84a5-4993-866c-981a8e935a32" name="ret_port" id="3ca34f19-f97b-4524-99c1-d28d1ad218fe" carrier="9f6aeb1a-138b-4bb9-9a09-d524e94658e6_ret"/>
      ...
      <asset xsi:type="esdl:Pipe" length="818.07" innerDiameter="0.3938" outerDiameter="0.56" name="Pipe1_1_ret" id="Pipe1_1_ret" state="OPTIONAL" related="Pipe1_1" diameter="DN400">
        <geometry xsi:type="esdl:Line">
        ...
        <port xsi:type="esdl:InPort" connectedTo="3ca34f19-f97b-4524-99c1-d28d1ad218fe" name="In_ret" id="31b83f9c-84a5-4993-866c-981a8e935a32" carrier="9f6aeb1a-138b-4bb9-9a09-d524e94658e6_ret"/>
        <port xsi:type="esdl:OutPort" connectedTo="4d6c18cd-cc52-443d-8e53-96cd188dd1a8" name="Out_ret" id="e78131b7-4501-4115-940e-ccc76617bccb" carrier="9f6aeb1a-138b-4bb9-9a09-d524e94658e6_ret"/>
      </asset>
      <asset xsi:type="esdl:Pipe" length="1182.23" innerDiameter="0.3938" outerDiameter="0.56" name="Pipe3_1_ret" id="Pipe3_1_ret" related="Pipe3_1" diameter="DN400">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="455.4" innerDiameter="0.3127" outerDiameter="0.45" name="Pipe4_1_ret" id="Pipe4_1_ret" related="Pipe4_1" diameter="DN300">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="252.3" innerDiameter="0.3127" outerDiameter="0.45" name="Pipe5_1_ret" id="Pipe5_1_ret" related="Pipe5_1" diameter="DN300">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="356.2" innerDiameter="0.263" outerDiameter="0.4" name="Pipe1_ret" id="Pipe1_ret" state="OPTIONAL" related="Pipe1" diameter="DN250">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99571274701101" lon="4.369031429215318"/>
      ...
      <asset xsi:type="esdl:Pipe" length="371.04" innerDiameter="0.3938" outerDiameter="0.56" name="Pipe2_ret" id="Pipe2_ret" related="Pipe2" diameter="DN400">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="146.5" innerDiameter="0.3938" outerDiameter="0.56" name="Pipe3_ret" id="Pipe3_ret" related="Pipe3" diameter="DN400">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99571274701101" lon="4.369031429215318"/>
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.9969414418569" lon="4.36826503796172"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" length="347.2" innerDiameter="0.3938" outerDiameter="0.56" name="Pipe4_ret" id="Pipe4_ret" state="OPTIONAL" related="Pipe4" diameter="DN400">
        <geometry xsi:type="esdl:Line">
