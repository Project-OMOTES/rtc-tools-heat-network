...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="PoC Tutorial_1source_GrowOptimized" description="" esdlVersion="v2207" version="18" id="3390fd46-7489-49a6-bcdc-9ec077e682a0">
  <instance xsi:type="esdl:Instance" name="Untitled instance" id="9af52a01-24e2-4bbe-a7b8-f868161e6ca3">
    <area xsi:type="esdl:Area" id="9edf5aa3-3855-4dac-b6f5-01c2edf1a43a" name="Untitled area">
      <area xsi:type="esdl:Area" id="76a75122-8ea6-472d-8059-374830275d72" name="Area_76a7">
        ...
        <KPIs xsi:type="esdl:KPIs" id="75dabfcb-fcbf-41b1-9740-fce0940fca69">
      ...
      <area xsi:type="esdl:Area" id="9d0fd9ed-662c-42ec-a417-7e789737084c" name="Area_9d0f">
        ...
        <KPIs xsi:type="esdl:KPIs" id="021e0e75-7724-434e-9aeb-35287d51d0bc">
          <kpi xsi:type="esdl:DoubleKPI" name="Investment" value="1.5">
            <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" multiplier="MEGA" unit="EURO" physicalQuantity="COST"/>
          </kpi>
          <kpi xsi:type="esdl:DoubleKPI" name="Installation" value="0.1">
      ...
      <area xsi:type="esdl:Area" id="a58a988c-95c1-492b-bc63-b125d25f5108" name="Area_a58a">
        ...
        <KPIs xsi:type="esdl:KPIs" id="6489ed53-36f2-47c9-b65f-84f8d5a7ca52">
          <kpi xsi:type="esdl:DoubleKPI" name="Investment" value="1.5">
            <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" multiplier="MEGA" unit="EURO" physicalQuantity="COST"/>
          </kpi>
          <kpi xsi:type="esdl:DoubleKPI" name="Installation" value="0.1">
      ...
      <KPIs xsi:type="esdl:KPIs" id="af341a5c-aa1e-458a-a0ca-b9139cdbaa6d">
        <kpi xsi:type="esdl:DistributionKPI" name="High level cost breakdown [EUR]">
          ...
          <distribution xsi:type="esdl:StringLabelDistribution">
            <stringItem xsi:type="esdl:StringItem" value="41480467.150537424" label="CAPEX"/>
            <stringItem xsi:type="esdl:StringItem" value="10125068.884223197" label="OPEX"/>
          </distribution>
        </kpi>
        <kpi xsi:type="esdl:DistributionKPI" name="Overall cost breakdown [EUR]">
          <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" unit="EURO" physicalQuantity="COST"/>
          <distribution xsi:type="esdl:StringLabelDistribution">
            <stringItem xsi:type="esdl:StringItem" value="1300000.0" label="Installation"/>
            <stringItem xsi:type="esdl:StringItem" value="40180467.150537424" label="Investment"/>
            <stringItem xsi:type="esdl:StringItem" value="5661318.915614213" label="Variable OPEX"/>
            <stringItem xsi:type="esdl:StringItem" value="4463749.968608983" label="Fixed OPEX"/>
          </distribution>
        </kpi>
        <kpi xsi:type="esdl:DistributionKPI" name="CAPEX breakdown [EUR]">
          <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" unit="EURO" physicalQuantity="COST"/>
          <distribution xsi:type="esdl:StringLabelDistribution">
            <stringItem xsi:type="esdl:StringItem" value="19598958.20253743" label="ResidualHeatSource"/>
            <stringItem xsi:type="esdl:StringItem" value="17081508.948" label="Pipe"/>
        ...
        <kpi xsi:type="esdl:DistributionKPI" name="OPEX breakdown [EUR]">
          <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" unit="EURO" physicalQuantity="COST"/>
          <distribution xsi:type="esdl:StringLabelDistribution">
            <stringItem xsi:type="esdl:StringItem" value="10125068.884223197" label="ResidualHeatSource"/>
          </distribution>
        </kpi>
        <kpi xsi:type="esdl:DistributionKPI" name="Energy production [Wh]">
          <distribution xsi:type="esdl:StringLabelDistribution">
            <stringItem xsi:type="esdl:StringItem" value="141532972890.3553" label="ResidualHeatSource_72d7"/>
          </distribution>
        </kpi>
      ...
      <asset xsi:type="esdl:ResidualHeatSource" power="37197916.40507486" id="72d74fb5-134f-4bfb-829e-220ab76a8a7b" name="ResidualHeatSource_72d7">
