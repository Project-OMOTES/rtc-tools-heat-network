...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="Demo_areas with return network" description="" version="14" esdlVersion="v2303" id="483e3ff5-7ff2-4b50-b7a3-c66cffe49703_with_return_network">
  <instance xsi:type="esdl:Instance" id="411b572c-f96b-49fa-8a0a-389705cbf58d" name="Untitled instance">
    <area xsi:type="esdl:Area" name="Delft" id="1e502f41-ce24-4609-b518-cd76a8aafb59">
      <area xsi:type="esdl:Area" id="72effb55-fb15-45a4-9e91-ed56104d777f" name="TUwijk">
        ...
        <asset xsi:type="esdl:HeatingDemand" power="25000000.0" id="c5c8678d-e624-4878-95cc-baa9e8809d5e" name="HeatingDemand_c5c8">
          ...
          <port xsi:type="esdl:InPort" connectedTo="3574833a-a997-42aa-b93f-2feb32350f9c" name="In" id="751b6c76-92d3-4d7c-83a9-ca90ddc73b0e" carrier="9e201a90-71c0-45bc-a683-6ae7e68b67d1">
            <profile xsi:type="esdl:InfluxDBProfile" multiplier="8.0" filters="" startDate="2018-12-31T23:00:00.000000+0000" field="demand2_MW" database="energy_profiles" host="profiles.warmingup.info" port="443" endDate="2019-12-31T22:00:00.000000+0000" id="5645e777-6500-4b99-80eb-6f09f8d8910e" measurement="WarmingUp default profiles">
        ...
        <asset xsi:type="esdl:HeatStorage" maxDischargeRate="1000000.0" capacity="3600000000.0" maxChargeRate="1000000.0" name="HeatStorage_171d" id="171dd49c-b2f2-47d0-99d8-a845ad9ee33b" state="OPTIONAL">
        ...
        <asset xsi:type="esdl:Joint" id="1591bb7b-d143-44fb-95b3-e78f2c45144c" name="Joint_1591">
        ...
        <asset xsi:type="esdl:Pipe" length="288.2" innerDiameter="0.3127" outerDiameter="0.45" name="Pipe8" id="Pipe8" state="OPTIONAL" related="Pipe8_ret" diameter="DN300">
        ...
        <asset xsi:type="esdl:Pipe" length="344.13" outerDiameter="0.45" innerDiameter="0.3127" id="Pipe6_ret" name="Pipe6_ret" related="Pipe6" diameter="DN300">
          <geometry xsi:type="esdl:Line">
        ...
        <asset xsi:type="esdl:Pipe" length="80.38" outerDiameter="0.45" innerDiameter="0.3127" id="Pipe7_ret" name="Pipe7_ret" related="Pipe7" diameter="DN300">
          <geometry xsi:type="esdl:Line">
        ...
        <asset xsi:type="esdl:Pipe" length="288.2" outerDiameter="0.45" innerDiameter="0.3127" id="Pipe8_ret" name="Pipe8_ret" state="OPTIONAL" related="Pipe8" diameter="DN300">
          <geometry xsi:type="esdl:Line">
      ...
      <area xsi:type="esdl:Area" id="4d129d60-44fb-49f1-b440-ee83b3396912" name="Xsport">
        ...
        <asset xsi:type="esdl:HeatingDemand" power="25000000.0" id="5d98329e-e593-4b67-aa8b-40ce2a9531db" name="HeatingDemand_5d98">
          ...
          <port xsi:type="esdl:InPort" connectedTo="0dfd35e1-3273-452b-a8e9-0edc558ad204" name="In" id="6d7f2662-daac-4f09-ad23-94069b7429b0" carrier="9e201a90-71c0-45bc-a683-6ae7e68b67d1">
            <profile xsi:type="esdl:InfluxDBProfile" multiplier="8.0" filters="" startDate="2018-12-31T23:00:00.000000+0000" field="demand4_MW" database="energy_profiles" host="profiles.warmingup.info" port="443" endDate="2019-12-31T22:00:00.000000+0000" id="e92f1544-5170-4922-b4fe-3ae0a298d0de" measurement="WarmingUp default profiles">
              <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitReference" reference="e9405fc8-5e57-4df5-8584-4babee7cdf1b"/>
            </profile>
          </port>
      ...
      <area xsi:type="esdl:Area" id="815405ce-057a-4229-9bcf-9c515813f780" name="Kluyverpark">
        ...
        <asset xsi:type="esdl:HeatingDemand" power="25000000.0" id="13d18f34-caa6-4fef-ba8e-8e2bbe3b184f" name="HeatingDemand_13d1">
          ...
          <port xsi:type="esdl:InPort" connectedTo="3367f7bc-73da-4669-8d92-817a6c355777" name="In" id="1c5f5573-fbd8-436b-b602-e8d085b38fae" carrier="e32b730d-4c75-4610-8ef7-dfcf461cc069">
            <profile xsi:type="esdl:InfluxDBProfile" multiplier="10.0" filters="" startDate="2018-12-31T23:00:00.000000+0000" field="demand5_MW" database="energy_profiles" host="profiles.warmingup.info" port="443" endDate="2019-12-31T22:00:00.000000+0000" id="10320809-979e-44e4-b39a-764ded8de3b7" measurement="WarmingUp default profiles">
              <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitReference" reference="e9405fc8-5e57-4df5-8584-4babee7cdf1b"/>
            </profile>
          </port>
        ...
        <asset xsi:type="esdl:GenericProducer" power="10000000.0" id="e7d42e39-275b-4723-88ce-6f53de43a1f9" name="GenericProducer_e7d4" state="OPTIONAL">
          ...
          <costInformation xsi:type="esdl:CostInformation" id="3b3ad03a-e25e-4a72-bedb-2d9e2f072c1f">
            ...
            <installationCosts xsi:type="esdl:SingleValue" value="500000.0" id="ad6887fe-665e-4cb7-a253-b02e634ee62a">
              <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" description="Cost in EUR" id="ab86121c-4475-429f-8e92-62b2dc2a7c9f" unit="EURO" physicalQuantity="COST"/>
            </installationCosts>
        ...
        <asset xsi:type="esdl:Pipe" length="283.4" innerDiameter="0.3127" outerDiameter="0.45" name="Pipe9" id="Pipe9" state="OPTIONAL" related="Pipe9_ret" diameter="DN300">
          <geometry xsi:type="esdl:Line" CRS="WGS84">
        ...
        <asset xsi:type="esdl:Pipe" length="129.8" innerDiameter="0.3127" outerDiameter="0.45" name="Pipe11" id="Pipe11" state="OPTIONAL" related="Pipe11_ret" diameter="DN300">
          <geometry xsi:type="esdl:Line" CRS="WGS84">
        ...
        <asset xsi:type="esdl:Pipe" length="283.4" outerDiameter="0.45" innerDiameter="0.3127" id="Pipe9_ret" name="Pipe9_ret" state="OPTIONAL" related="Pipe9" diameter="DN300">
          <geometry xsi:type="esdl:Line">
        ...
        <asset xsi:type="esdl:Pipe" length="96.5" outerDiameter="0.45" innerDiameter="0.3127" id="Pipe10_ret" name="Pipe10_ret" related="Pipe10" diameter="DN300">
          <geometry xsi:type="esdl:Line">
        ...
        <asset xsi:type="esdl:Pipe" length="129.8" outerDiameter="0.45" innerDiameter="0.3127" id="Pipe11_ret" name="Pipe11_ret" state="OPTIONAL" related="Pipe11" diameter="DN300">
          <geometry xsi:type="esdl:Line">
            <point xsi:type="esdl:Point" CRS="WGS84" lat="51.990448299678164" lon="4.378908311071035"/>
      ...
      <asset xsi:type="esdl:ResidualHeatSource" power="30000000.0" id="ec0a2222-d6fe-4cb6-aff0-237e08174fa8" name="ResidualHeatSource_ec0a" state="OPTIONAL">
        ...
        <costInformation xsi:type="esdl:CostInformation" id="df01f903-c501-4fb3-9216-744e490d92cb">
          ...
          <installationCosts xsi:type="esdl:SingleValue" value="1000000.0" id="2b3593ea-6359-4cc1-b099-53a6d3af7ec5">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" description="Cost in EUR" id="eb86cc68-4c3b-4767-ba2d-2fda540637d2" unit="EURO" physicalQuantity="COST"/>
          </installationCosts>
      ...
      <asset xsi:type="esdl:ResidualHeatSource" power="50000000.0" id="54b13f38-8835-4e75-8acc-780a14fa8dbd" name="ResidualHeatSource_54b1" state="OPTIONAL">
        ...
        <costInformation xsi:type="esdl:CostInformation" id="ed861601-3428-4381-88cb-9a1452aed93e">
          ...
          <installationCosts xsi:type="esdl:SingleValue" value="1000000.0" id="bad6f69c-e77b-497e-b0be-83df5b7680df">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" description="Cost in EUR" id="8abbad22-0502-4c21-bbf9-7a7c0baa4341" unit="EURO" physicalQuantity="COST"/>
          </installationCosts>
      ...
      <asset xsi:type="esdl:Pipe" length="843.42" innerDiameter="0.3938" outerDiameter="0.56" name="Pipe1" id="Pipe1" state="OPTIONAL" related="Pipe1_ret" diameter="DN400">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Joint" id="b3e415da-242d-4003-8a26-447529a7a9e4" name="Joint_b3e4">
      ...
      <asset xsi:type="esdl:Pipe" length="734.05" innerDiameter="0.3938" outerDiameter="0.56" name="Pipe3" id="Pipe3" state="OPTIONAL" related="Pipe3_ret" diameter="DN400">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lat="51.99407031543172" lon="4.370262622833253"/>
      ...
      <asset xsi:type="esdl:Joint" id="21a04f29-2a92-4e5f-8160-072fc4db05fc" name="Joint_21a0">
      ...
      <asset xsi:type="esdl:Pipe" length="386.9" innerDiameter="0.3127" outerDiameter="0.45" name="Pipe5" id="Pipe5" state="OPTIONAL" related="Pipe5_ret" diameter="DN300">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" length="843.42" outerDiameter="0.56" innerDiameter="0.3938" id="Pipe1_ret" name="Pipe1_ret" state="OPTIONAL" related="Pipe1" diameter="DN400">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99914772322822" lon="4.366580576596763"/>
      ...
      <asset xsi:type="esdl:Pipe" length="588.97" outerDiameter="0.56" innerDiameter="0.3938" id="Pipe2_ret" name="Pipe2_ret" related="Pipe2" diameter="DN400">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="734.05" outerDiameter="0.56" innerDiameter="0.3938" id="Pipe3_ret" name="Pipe3_ret" state="OPTIONAL" related="Pipe3" diameter="DN400">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.9900841009021" lon="4.3751606570700075"/>
      ...
      <asset xsi:type="esdl:Pipe" length="314.5" outerDiameter="0.45" innerDiameter="0.3127" id="Pipe4_ret" name="Pipe4_ret" related="Pipe4" diameter="DN300">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="386.9" outerDiameter="0.45" innerDiameter="0.3127" id="Pipe5_ret" name="Pipe5_ret" state="OPTIONAL" related="Pipe5" diameter="DN300">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99416031552172" lon="4.369452758355907"/>
