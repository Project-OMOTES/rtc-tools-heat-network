model Example
  ...
  Pipe pipe1aC(length = 170.365, diameter  = 0.15, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe1bC(length = 309.635, diameter  = 0.15, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe4aC(length = 5, diameter  = 0.15, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe4bC(length = 15, diameter  = 0.15, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe5C(length = 126, diameter  = 0.15, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe7C(length = 60, diameter  = 0.15, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe9C(length = 70, diameter  = 0.15, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe15C(length = 129, diameter  = 0.15, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe25C(length = 150, diameter  = 0.15, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe26C(length = 30, diameter  = 0.1, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe27C(length = 55, diameter  = 0.15, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe29C(length = 134, diameter  = 0.15, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe30C(length = 60, diameter  = 0.1, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe31C(length = 60, diameter  = 0.1, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe32C(length = 50, diameter  = 0.1, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe52_inC(length = 10, diameter  = 0.164, temperature=45.0, Q(nominal=Q_nominal));
  Pipe pipe52_outC(length = 10, diameter  = 0.164, temperature=45.0, Q(nominal=Q_nominal));
  ...
  Pipe pipe1aH(length = 170.365, diameter  = 0.15, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe1bH(length = 309.635, diameter  = 0.15, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe4aH(length = 5, diameter  = 0.15, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe4bH(length = 15, diameter  = 0.15, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe5H(length = 126, diameter  = 0.15, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe7H(length = 60, diameter  = 0.15, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe9H(length = 70, diameter  = 0.15, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe15H(length = 129, diameter  = 0.15, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe25H(length = 150, diameter  = 0.15, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe26H(length = 30, diameter  = 0.1, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe27H(length = 55, diameter  = 0.15, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe29H(length = 134, diameter  = 0.15, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe30H(length = 60, diameter  = 0.1, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe31H(length = 60, diameter  = 0.1, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe32H(length = 50, diameter  = 0.1, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe52_inH(length = 10, diameter  = 0.164, temperature=75.0, Q(nominal=Q_nominal));
  Pipe pipe52_outH(length = 10, diameter  = 0.164, temperature=75.0, Q(nominal=Q_nominal));
