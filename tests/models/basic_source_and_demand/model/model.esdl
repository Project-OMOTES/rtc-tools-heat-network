...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" id="e9149356-35f5-438e-ab49-227b81e6033d" name="sourcesinkpump" description="">
  <instance xsi:type="esdl:Instance" id="bf32dd63-663c-4dc9-b3b4-1e89e0839607" name="Untitled instance">
    <area xsi:type="esdl:Area" id="276b0282-d062-447b-87f7-6348766c8ada" name="Untitled area">
      <asset xsi:type="esdl:ResidualHeatSource" power="100000.0" name="source" id="a0f6ddac-c2a7-41e3-8499-bbbafb9efb9b" minTemperature="65.0" maxTemperature="85.0">
        <geometry xsi:type="esdl:Point" lat="51.98871401358563" lon="4.382870346307755" CRS="WGS84"/>
        <port xsi:type="esdl:InPort" connectedTo="2c613379-d423-4f8c-a536-2d7e9c66cf0d" name="In" id="22f71e37-2e23-42c0-bc0e-fdf43be5c4cf" carrier="b8032169-3d40-45c0-8c1f-b57680185c1e"/>
      ...
      <asset xsi:type="esdl:Pipe" innerDiameter="0.13" outerDiameter="0.2425" name="pipe" id="51c44578-5f62-4a77-b29a-ee829a3c2e8c" length="1000.0">
        ...
        <material xsi:type="esdl:CompoundMatter" compoundType="LAYERED">
          <component xsi:type="esdl:CompoundMatterComponent" layerWidth="0.075">
            <matter xsi:type="esdl:Material" id="4608b0db-0dac-4ff4-a4c4-7cd20a29c406" thermalConductivity="0.033" name="PUR"/>
          </component>
        </material>
      ...
      <asset xsi:type="esdl:HeatingDemand" name="demand" id="921eb017-927b-4789-98c8-41adbd70552c" power="200000.0" minTemperature="70.0">
        ...
        <port xsi:type="esdl:OutPort" name="Out" id="75ddd94c-cc82-4967-8444-b8a7b1e5611e" connectedTo="ec06d9f1-df98-4125-b288-e9a290809d85" carrier="b8032169-3d40-45c0-8c1f-b57680185c1e"/>
      </asset>
      <asset xsi:type="esdl:Pipe" length="1000.0" innerDiameter="0.13" name="pipe_ret" outerDiameter="0.2425" id="0007ad4d-feb6-43b8-a819-9ca5d71b7c86">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
        ...
        <port xsi:type="esdl:InPort" connectedTo="75ddd94c-cc82-4967-8444-b8a7b1e5611e" name="In" id="ec06d9f1-df98-4125-b288-e9a290809d85" carrier="b8032169-3d40-45c0-8c1f-b57680185c1e"/>
        <port xsi:type="esdl:OutPort" name="Out" id="400bcc06-999b-4caf-9443-fb2b0fd5c51c" connectedTo="c6366adf-653c-4525-b8ea-7abc28a05efe" carrier="b8032169-3d40-45c0-8c1f-b57680185c1e"/>
      </asset>
      <asset xsi:type="esdl:Pump" name="pump" id="ed1a5711-9b98-4659-896b-b0ade8633e33" pumpCapacity="5000.0">
        ...
        <port xsi:type="esdl:InPort" connectedTo="400bcc06-999b-4caf-9443-fb2b0fd5c51c" name="In" id="c6366adf-653c-4525-b8ea-7abc28a05efe" carrier="b8032169-3d40-45c0-8c1f-b57680185c1e"/>
        <port xsi:type="esdl:OutPort" name="Out" id="2c613379-d423-4f8c-a536-2d7e9c66cf0d" connectedTo="22f71e37-2e23-42c0-bc0e-fdf43be5c4cf" carrier="b8032169-3d40-45c0-8c1f-b57680185c1e"/>
      </asset>
    </area>
  </instance>
